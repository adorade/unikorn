...
$(() => {
  ...
  test('Util.getSelectorFromElement should return the correct element', (assert) => {
    assert.expect(2)
  ...
  test('Util.getTransitionDurationFromElement should accept transition durations in milliseconds', (assert) => {
    assert.expect(1)
  ...
  test('Util.getTransitionDurationFromElement should accept transition durations in seconds', (assert) => {
    assert.expect(1)
  ...
  test('Util.getTransitionDurationFromElement should get the first transition duration if multiple transition durations are defined', (assert) => {
    assert.expect(1)
  ...
  test('Util.getTransitionDurationFromElement should return 0 if transition duration is not defined', (assert) => {
    assert.expect(1)
  ...
  test('Util.getTransitionDurationFromElement should return 0 if element is not found in DOM', (assert) => {
    assert.expect(1)
  ...
  test('Util.getUID should generate a new id uniq', (assert) => {
    assert.expect(2)
  ...
  test('Util.supportsTransitionEnd should return true', (assert) => {
    assert.expect(1)
    assert.ok(Util.supportsTransitionEnd())
  })

  test('Util.findShadowRoot should find the shadow DOM root', (assert) => {
