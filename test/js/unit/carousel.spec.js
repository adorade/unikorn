$(function () {
  ...
  test('should return carousel version', (assert) => {
    assert.expect(1)
  ...
  test('Should not go to the next item when the carousel is not visible', (assert) => {
    ...
    $html.appendTo('#qunit-fixture').unikornCarousel()
